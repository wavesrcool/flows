...
exports.FlowsCoreIoAccounts = void 0;
/* eslint-disable @typescript-eslint/no-explicit-any */
const flows_io_1 = require("@wavesrcool/flows-io");
class FlowsCoreIoAccounts {
    constructor(figure) {
        this.ioAccountsFigure = figure;
    }
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            (0, flows_io_1.FlowsIoAccounts)(this.ioAccountsFigure)
                .then(() => {
...
exports.FlowsCoreIoAccounts = FlowsCoreIoAccounts;
